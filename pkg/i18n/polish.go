...
func polishSet() TranslationSet {
	return TranslationSet{
		...
		RunningCustomCommandStatus: "uruchamianie własnej komendy",
		RunningBulkCommandStatus:   "uruchamianie zbiorczej komendy",
		...
		CannotKillChildError:              "Czekano trzy sekundy, aby proces potomny się zatrzymał. Mogą istnieć osierocone procesy działające na Twoim systemie.",
		...
		RemoveAllContainers: "usuń wszystkie kontenery (siłą)",
		ViewBulkCommands:    "pokaż zbiorcze komendy",
		...
		BulkCommandTitle:          "Zbiorcza komenda:",
		ErrorTitle:                "Błąd",
		LogsTitle:                 "Logi",
